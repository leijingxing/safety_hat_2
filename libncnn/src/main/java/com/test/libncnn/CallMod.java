...
public class CallMod extends BaseAi {

    @Override
    public boolean loadModel(AssetManager mgr, int modelid, int cpugpu){
        return callLoadModel(mgr, modelid, cpugpu);
    }
    ...
    public void onValue(CallMod obj, String[] value) {
     ...
     */
    public native boolean callLoadModel(AssetManager mgr, int modelid, int cpugpu);
