...
//                        recycle_frame(frame_mjpeg);
                        recycle_frame(frame);
                        addCaptureFrame(frame_mjpeg); // 修改成 mjpeg原始数据
...
//            if (mFrameCallbackFunc) { //mFrameCallbackFunc 转码函数
...
//            LOGI("do_capture_callback   data_bytes:%zu  capacity_bytes:%zu", callback_frame->data_bytes, callback_frame->capacity_bytes);
